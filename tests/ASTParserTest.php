...
class ASTParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_variable()
    {
        ...
        $expected = $this->f->root([$this->f->assignment(
    ...
    public function test_any()
    {
        ...
        $expected = $this->f->any([$this->f->name("Classes")
            , $this->f->name("Functions")
            ]);
    ...
    public function test_classes_cannot_contain_text()
    {
        ...
        $expected = $this->f->root([$this->f->rule(
                    $this->f->cannot(),
                    $this->f->property(
                        $this->f->name("Classes"),
    ...
    public function test_explain_variables()
    {
        ...
        $expected = $this->f->root([$this->f->explanation("Explanation")
            , $this->f->assignment(
                    $this->f->name("AllClasses"),
                    $this->f->name("Classes")
                )
