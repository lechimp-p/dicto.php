...
class NullDB implements Insert, Query {
    ...
    public function definition($name, $type, $file, $start_line, $end_line) { return array(0,0); }
    public function method_info($name_id, $class_name_id, $definition_id) { return null; }
