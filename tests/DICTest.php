...
class DICTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $expected_schemas = array( new \Lechimp\Dicto\Rules\DependOn
    ...
    {
        $expected_variables = array( new \Lechimp\Dicto\Variables\Everything()
    ...
    {
        $default_variables = array( \Lechimp\Dicto\Variables\Classes::class
        ...
        $expected_variables = array( new \Lechimp\Dicto\Variables\Classes()
            , new \Lechimp\Dicto\Variables\Functions()
            , new \Lechimp\Dicto\Variables\Globals()
            , new \Lechimp\Dicto\Variables\Files()
            , new \Lechimp\Dicto\Variables\Methods()
